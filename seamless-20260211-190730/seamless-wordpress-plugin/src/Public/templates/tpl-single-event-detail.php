...
// error_log('event_type: ' . print_r($event, true));
$title = $event['title'] ?? '';
...
$calendar_description = !empty($event['excerpt_description'])
  ? wp_strip_all_tags($event['excerpt_description'])
  ...
  <div class="event-main-content">
    <div class="event-header">
      ...
      <div class="event-header-text">
        ...
        <?php if (!empty($event['excerpt_description'])) : ?>
          <div class="event-excerpt-description">
            <?= wp_kses_post($event['excerpt_description']); ?>
          </div>
        <?php endif; ?>
      </div>
    </div>
