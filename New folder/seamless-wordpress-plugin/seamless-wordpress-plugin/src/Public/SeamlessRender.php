...
class SeamlessRender
{
	...
	public function enqueue_seamless_assets()
	{
		...
		if (file_exists($dist_path . $seamless_js_file)) {
			...
			// Localize script with WordPress site configuration
			wp_localize_script('seamless-vite-main-js', 'seamlessConfig', [
	...
	private function register_shortcodes(): void
	{
		...
		// New: Customizable Events shortcode
	...
	public function shortcode_custom_events($atts = []): string
	{
		...
		return '<div class="seamless-custom-events-container" data-view="' . esc_attr($view) . '" data-params="' . esc_attr($params) . '"><div class="loader"></div></div>';
	}
