...
$events_page_url = site_url('/events/');
...
if ($event_type === 'group_event') {
  ...
  try {
      $timezone_obj = new DateTimeZone('America/Chicago');
  } catch (Exception $e) {
      $timezone_obj = function_exists('wp_timezone') ? wp_timezone() : new DateTimeZone(wp_timezone_string());
  }
}
